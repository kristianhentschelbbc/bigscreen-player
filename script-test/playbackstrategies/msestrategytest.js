      ...
      beforeAll(function () {
        ...
        mockDashInstance = jasmine.createSpyObj('mockDashInstance',
          ['initialize', 'retrieveManifest', 'getDebug', 'getSource', 'on', 'off', 'time', 'duration', 'attachSource',
            ...
            'setBufferAheadToKeep', 'setBufferTimeAtTopQuality', 'setBufferTimeAtTopQualityLongForm', 'getBitrateInfoListFor', 'getAverageThroughput', 'getDVRWindowSize', 'setLiveDelay', 'setFragmentRequestTimeout']);
